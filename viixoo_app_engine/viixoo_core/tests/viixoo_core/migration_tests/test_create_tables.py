...
class TestMigration(unittest.TestCase):
    ...
    def test_generate_create_table_query(self, mock_get_connection):
        ...
        schema = {
            ...
            "created_at": {"type": "TIMESTAMP WITHOUT TIME ZONE", "required": False, "default": "2023-01-01"},
        }
        ...
        alter_table = f""" ALTER TABLE users ADD CONSTRAINT category_id_fk"""
        references = f""" FOREIGN KEY (category_id) REFERENCES categories.id"""
        polities_fk = f""" ON DELETE SET NULL ON UPDATE CASCADE;"""
    ...
    def test_generate_create_table_query_no_fk(self, mock_get_connection):
        ...
        # Expected SQL queries
        expected_create_query = (
            "CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY, name CHARACTER VARYING NOT NULL, age INTEGER, is_active BOOLEAN NOT NULL, created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT '2023-01-01'::TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT name_unique UNIQUE (name));"
        )
    ...
    def test_generate_create_table_query_no_required(self, mock_get_connection):
        ...
        # Expected SQL queries
        expected_create_query = (
            "CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY, name CHARACTER VARYING, age INTEGER, is_active BOOLEAN, created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT '2023-01-01'::TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT name_unique UNIQUE (name));"
        )
    ...
    def test_generate_create_table_query_default(self, mock_get_connection):
        ...
        schema = {
            "id": {"type": "SERIAL PRIMARY KEY", "required": True},
            "name": {"type": "CHARACTER VARYING", "required": False, "unique": True, "default":"test"},
        ...
        # Expected SQL queries
        expected_create_query1 = "CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY, name CHARACTER VARYING DEFAULT 'test'::CHARACTER VARYING,"
    ...
    def test_generate_create_table_query_all_options(self, mock_get_connection):
        ...
        schema = {
            "id": {"type": "SERIAL PRIMARY KEY", "required": True},
            "name": {"type": "CHARACTER VARYING", "required": True, "unique": True, "default": "test"},
        ...
        # Expected SQL queries
        expected_create_query1 = """CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY,"""
        expected_create_query2 = """ name CHARACTER VARYING NOT NULL DEFAULT 'test'::CHARACTER VARYING,"""
        expected_create_query3 = """ age INTEGER NOT NULL DEFAULT '18'::INTEGER,"""
        expected_create_query4 = """ is_active BOOLEAN NOT NULL DEFAULT 'False'::BOOLEAN,"""
    ...
    def test_generate_create_table_query_no_on_delete(self, mock_get_connection):
        ...
        # Expected SQL queries
        expected_create_query = (
            "CREATE TABLE IF NOT EXISTS users (id SERIAL PRIMARY KEY, category_id INTEGER);"
        )
        alter_table = f""" ALTER TABLE users ADD CONSTRAINT category_id_fk"""
        references = f""" FOREIGN KEY (category_id) REFERENCES categories.id;"""
