...
class TestMigrationRun:
    ...
    def test_run_postgresql(self, mock_run_postgresql_migrations, mock_get_config, mock_import_module, mock_get_modules, capsys):
        ...
        mock_import_module.side_effect = [{'module1': MagicMock()}, {'module2': MagicMock()}]
        ...
        mock_run_postgresql_migrations.assert_called()
    ...
    def test_run_unsupported_db(self, mock_get_config, mock_import_module, mock_get_modules):
        ...
        # Arrange
        mock_get_modules.return_value = ['module1']
    ...
    def test_run_module_exception(self, mock_run_postgresql_migrations, mock_get_config, mock_import_module, mock_get_modules, capsys):
        ...
        # Arrange
        mock_get_modules.return_value = ['module1', 'module2_raise_error']
        mock_import_module.side_effect = [{'module1': MagicMock()}, Exception("Some error")]
        ...
        # Assert
        assert mock_get_modules.call_count == 1
        assert mock_import_module.call_count == 2
        assert mock_get_config.call_count == 2
